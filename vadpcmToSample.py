...
class UI(QMainWindow):
    ...
    def Looop(self):
        ...
        else: self.spinBox3.setEnabled(False)
    def Convert(self):
        ...
        if fneme[0]:
            ...
            fyle.seek(68)
            fyle.write(len(self.dataa).to_bytes(4))
            fyle.seek(68)
            swep = fyle.read(1)
            swap = fyle.read(1)
            swup = fyle.read(1)
            ...
            fyle.write(self.spinBox3.value().to_bytes(4))
            ...
            fyle.write(swap)
            fyle.write(swep)
            fyle.write(self.spinBox.value().to_bytes(4))
            ...
            fyle.write(int(soup).to_bytes(2))
